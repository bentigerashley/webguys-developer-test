...
const links = [["About Us", "#about", false], ["Our Services", "#services", true], ["Our Approach", "#about", true], ["Our Projects", "#cases", false]] as const;
...
export function SiteHeader() {
  ...
  return <header className="site-header">
    ...
    <nav className="desktop-nav" aria-label="Primary">{links.map(([label, href, chevron]) => <a key={label} href={href}>{label}{chevron && <span aria-hidden="true">⌄</span>}</a>)}<a className="nav-cta" href="#contact">Contact Us</a></nav>

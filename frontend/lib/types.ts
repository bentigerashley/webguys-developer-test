...
export type PartnersBlock = { type: "partners"; heading: string; intro: string; partners: Partner[] };
...
export type HomeBlock = HeroBlock | AboutBlock | ServicesBlock | CasesBlock | PartnersBlock | AwardsBlock | LatestNewsBlock | ContactBlock;
